...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:POt81DvegnpQKM4DMDLlHz1CO6OBnEoQ1gRhYFd7QRY=",
        version = "v1.50.32",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:n1DH8TPV4qqPTje2RcUBYwtrTWlabVp4n46+74X2pn4=",
        version = "v1.10.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:4W97RJLJSUQ3veRZDNbp1Ol3Rbn6Lmt9bKGvfqYI5SU=",
        version = "v1.109.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:rVisxQPdETctjlYntm0Ek4dKf68nAQocCloCT50vWuI=",
        version = "v0.21.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:DPYOrm6gexCfZZfXUaXFS4+Jw6HAaIIG0SZ5630f8yw=",
        version = "v0.22.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:SE9m0W6DEfgIVCJX7xU+iv/hUl4m/nxqMTnCdMxDpJ8=",
        version = "v0.16.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:fI1LXuBaS1d9z1kmb++Og6YD8uMRwadXorCwE+xgOFA=",
    ...
    go_repository(
        ...
        sum = "h1:gDSQWAbKMAQX8db9FDCXHhodQPrJmLcmthjx6m+PyV4=",
        version = "v1.29.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:nuwTDY/15McImfuXcUD6AA3alpUNEXfWws8K/8SXr68=",
        version = "v0.49.1-0.20240306132007-4199f18c3e92",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:/8rfZAdFfafRXOgz+ZpMZZWZ5pYggCY9t7e/BvjaBHM=",
    ...
    go_repository(
        ...
        sum = "h1:UJcjSAI3aUKx52kfcfhblgyhZceouhvvs3OYdWgn+PY=",
        version = "v1.7.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:nrFSx+zfjdisjE9oCx25Aep3nJ9RaUjeE1qFL6eovoU=",
        version = "v1.3.0",
    )
    go_repository(
        ...
        sum = "h1:JRYN7tVHYFwmtQhIYbxWeiKSa2L1nCohyAs8sYqKFZo=",
        version = "v1.3.0",
    )
    go_repository(
        ...
        sum = "h1:DrZy8BpzJDnN2zFxXRj6BhfGYxNlqpFHBqyuS9fVHRY=",
        version = "v0.96.0",
    )
    go_repository(
